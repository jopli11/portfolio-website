...
const mockTopRepos: GitHubRepo[] = [
  {
    id: 1,
    name: "dragon-competitions",
    description: "A high-performance, skill-based raffle platform built with Next.js, Firebase, and Contentful.",
    html_url: "https://github.com/jopli11/dragon-competitions",
    language: "TypeScript",
    stargazers_count: 1,
    forks_count: 0,
  ...
  },
  {
    id: 2,
    name: "osrs-skills",
    description: "A fast, mobile-first OSRS skill calculator with 100% mathematical parity with OldSchool.tools.",
    html_url: "https://github.com/jopli11/osrs-skills",
    language: "TypeScript",
    stargazers_count: 0,
    forks_count: 0,
  ...
  {
    id: 3,
    name: "probemas-boosting",
    description: "High-conversion service platform for OSRS players with Discord integration and loyalty points.",
    html_url: "https://github.com/jopli11/probemas-boosting",
    language: "TypeScript",
    stargazers_count: 1,
    forks_count: 0,
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <MagneticButton>
                <motion.button
                  ...
                  className="bg-gradient-to-r from-emerald-600 to-cyan-600 hover:from-emerald-700 hover:to-cyan-700 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-300 w-full sm:w-auto"
                >
                  Get In Touch
                </motion.button>
              </MagneticButton>
